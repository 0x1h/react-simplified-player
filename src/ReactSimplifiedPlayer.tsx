...
export const ReactSimplifiedPlayer: FC<PlayerProps> = (props) => {
  ...
  const onTimeEnd = () => {
    ...
    if (props.onAudioEnded !== undefined)
  ...
  useEffect(() => {
    if (control.playing) {
      ...
      if (props.onAudioPlay !== undefined)
        props.onAudioPlay!(songData[currentIndex]);
    }
    if (!control.playing) {
      currentRef.current?.pause();
      if (props.onAudioPause !== undefined)
        props.onAudioPause!(songData[currentIndex]);
    }
  }, [control]);
        ...
        <ConfigPanel
          ...
          setVolume={(volumee) =>
            setVolume(() => {
              ...
              if (props.onVolumeChange !== undefined)
